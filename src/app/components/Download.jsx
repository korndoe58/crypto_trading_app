...
export default function Download() {
    return <div className=" w-full h-[50vh] p-4  ">
        {/* wrapper */}
        <div className=" w-full h-full p-4 flex flex-col justify-around items-start backdrop-blur-sm bg-white/10 rounded-lg">
            {/* text container */}
            ...
            <div className=" flex flex-col items-start gap-2">
                <button><Image src={'/appbutton.png'} alt='logo' width={150} height={100} /></button>
