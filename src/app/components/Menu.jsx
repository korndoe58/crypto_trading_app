...
const Menu = () => {
  ...
  return (
    ...
    />
    {open && (
      <div className="  backdrop-blur-sm bg-white/50 text-black font-semibold absolute left-0 bottom-0 w-full h-[calc(100vh-4rem)] flex flex-col gap-8 items-center justify-center text-3xl z-10  ">
        {links.map((item) => (
